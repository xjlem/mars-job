...
public class KryoUtil {
     ...
     * @return 序列化后的字符串
     */
    public static <T> String writeClassAndObjectToString(T obj) {
        try {
            return new String(Base64.encodeBase64(writeClassAndObject(obj)), DEFAULT_ENCODING);
     ...
     * @return 原对象
     */
    public static <T> T readClassAndObjectFromString(String str) {
        try {
            return readClassAndObject(Base64.decodeBase64(str.getBytes(DEFAULT_ENCODING)));
        } catch (UnsupportedEncodingException e) {
            throw new IllegalStateException(e);
        }
    }
